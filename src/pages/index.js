        ...
        <section className="finaid">
          <Container className="cols">
            <div className="col-60">
              ...
              <p>
                You may be eligible to receive a non-resident tuition waiver through our UNLV Western Undergraduate
                Exchange (WUE) scholarship if you're entering the freshmen class or identify as a transfer student. In
                order to qualify, you must reside in one of the following states or territories:
              </p>
              <p className="states">
                <strong>
                  Alaska, Arizona, California, Colorado, Hawaii, Idaho, Montana, New Mexico, North Dakota, Oregon, South
                  Dakota, Utah, Washington, Wyoming, Guam, and the Commonwealth of the Northern Marianas Islands.
                </strong>
              </p>
              <ul>
                <li>NO application necessary.</li>
                <li>Estimated savings for full-time enrollment is approximately $11,000 per year.</li>
                <li>Awards are offered to the UNLV entering freshmen class and eligible transfer students. </li>
                <li>
                  Students admitted by the November 1st deadline who meet eligibility requirements will be given
                  priority consideration
                </li>
                <li>Students are encouraged to apply for admission to UNLV as early as possible.</li>
              </ul>
            </div>
        ...
        <section className="concentrations">
          <Container>
            ...
            <div className="cols">
              ...
              <article className="col-50">
                <h4>Hospitality and Beverage Management</h4>
                <StaticImage
                  src="../assets/hospitality-and-beverage-management.jpg"
                  alt="Hospitality and Beverage Management"
                  placeholder="blurred"
                  loading="lazy"
                />
                <p>
        ...
        <section className="video">
          <Container>
            <div className="cols">
              ...
              <div className="col-40">
                <h2>Learn More About The Hospitality Management Degree Program at UNLV</h2>
              </div>
            </div>
          </Container>
        </section>
